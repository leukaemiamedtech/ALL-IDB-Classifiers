...
- [Summary](#summary)
    - [Adam Optimizer NVIDIA 1050 ti GPU (Unstable)](#adam-optimizer-nvidia-1050-ti-gpu-unstable)
    - [RMSprop Optimizer NVIDIA 1050 ti GPU (Unstable)](#rmsprop-optimizer-nvidia-1050-ti-gpu-unstable)
    - [Adam Optimizer Mac 2,8 GHz Intel Core i5 (Stable)](#adam-optimizer-mac-28-ghz-intel-core-i5-stable)
    - [RMSprop Optimizer Mac 2,8 GHz Intel Core i5 (Stable)](#rmsprop-optimizer-mac-28-ghz-intel-core-i5-stable)
...
Now you need to move your ALL-IDB1 dataset to the **ALL-IDB18** directory in the **Model/Data/ALL-IDB-1** directory.

&nbsp;

# Configuration

[config.json](../Model/config.json "config.json")  holds the configuration for all of the networks that make  the ALL IDB Classifiers project. 
...
- [AllCnn.py](../AllCnn.py "AllCnn.py"): A wrapper class.
- [Helpers.py](../Classes/Helpers.py "Helpers.py"): A helper class.
- [DataP1.py](../Classes/DataP1.py "DataP1.py"): A data helpers class.
- [ModelP1.py](../Classes/ModelP1.py "ModelP1.py"): A model helpers class.
...
|    Class | Description |
| ------------- | ------------ |
| Helpers.py   | [Helpers.py](../Classes/Helpers.py "Helpers.py") is a helper class for the Tensorflow 2.0 ALL Papers project. The class loads the configuration and logging that the project uses.      |
| DataP1.py | [DataP1.py](../Classes/DataP1.py "DataP1.py") is a data helper class for the Paper 1 Evaluation. The class provides the functionality for sorting and preparing your training and validation data. the functions in this class reproduce the training and validation data split proposed in the [Acute Leukemia Classification Using Convolution Neural Network In Clinical Decision Support System](https://airccj.org/CSCP/vol7/csit77505.pdf "Acute Leukemia Classification Using Convolution Neural Network In Clinical Decision Support System") paper.       |     |
| ModelP1.py | [ModelP1.py](../Classes/ModelP1.py "ModelP1.py") is a model helper class for the Paper 1 Evaluation. The class provides the functionality for creating our CNN.       |
...
![Asociacion De Investigacion En Inteligencia Artificial Para La Leucemia Peter Moss](../Model/metrics.png)
...
![Asociacion De Investigacion En Inteligencia Artificial Para La Leucemia Peter Moss](../Model/metrics-rms.png)
...
![Asociacion De Investigacion En Inteligencia Artificial Para La Leucemia Peter Moss](../Model/metrics-adam-mac-i5.png)
...
![Asociacion De Investigacion En Inteligencia Artificial Para La Leucemia Peter Moss](../Model/metrics-rms-mac-i5.png)
...
## Adam Optimizer NVIDIA 1050 ti GPU (Unstable)
